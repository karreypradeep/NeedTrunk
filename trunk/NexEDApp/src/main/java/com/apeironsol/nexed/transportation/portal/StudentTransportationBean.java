 ...
 * 
 */
package com.apeironsol.nexed.transportation.portal;
...
import com.apeironsol.nexed.core.portal.StudentBean;
import com.apeironsol.nexed.transportation.model.Route;
import com.apeironsol.nexed.transportation.model.Vehicle;
import com.apeironsol.nexed.transportation.service.RouteService;
import com.apeironsol.nexed.transportation.service.StudentTransportationService;
import com.apeironsol.nexed.transportation.service.VehicleService;
...
public class StudentTransportationBean extends AbstractTransportationBean {
	...
	private static final Logger					log						= Logger.getLogger(StudentTransportationBean.class);
	...
	public void assignStudentTransportation() {
		try {
			...
			if (studentTransportation.getId() == null) {
	...
	public void unassignStudentTransportation() {
		...
		try {
			...
			this.studentTransportationService.unassignStudentTransportation(studentTransportation.getId());
