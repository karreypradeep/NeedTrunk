...
public class BuildingBlockTest {
	...
	public void setUpServletContext() {
		 ...
		 * servletContext.addInitParameter(ContextParams.SYSTEM_TIMEZONE,
		 * "Asia/Kolkata");
	...
	public void sampleTest() {
		 ...
		 * this.buildingBlock.setFeeClassificationLevel(
		 * FeeClassificationLevelConstant.KLASS_LEVEL);
		 ...
		 * final BuildingBlock result =
		 * this.buildingBlockService.saveBuildingBlock(this.buildingBlock);
