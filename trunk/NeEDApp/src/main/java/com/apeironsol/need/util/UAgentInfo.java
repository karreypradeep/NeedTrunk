 ...
 * // Updates:
 * // - Updated DetectMobileQuick(). Moved the 'Exclude Tablets' logic to the
 * top of the method to fix a logic bug.
 * //
 ...
 * // - Added support for BlackBerry 10 OS: variable and
 * DetectBlackBerry10Phone().
 * // - Added support for PlayStation Vita handheld: variable and
 * DetectGamingHandheld().
 * // - Updated DetectTierIphone(). Added Tizen; updated the Windows Phone,
 * BB10, and PS Vita support.
 * // - Updated DetectWindowsMobile(). Uses generic DetectWindowsPhone() method
 * rather than WP7.
 * // - Updated DetectSmartphone(). Uses the detectTierIphone() method.
 * // - Updated DetectSonyMylo() with more efficient code.
 * // - Removed DetectGarminNuvifone() from DetectTierIphone(). How many are
 * left in market in 2013? It is detected as a RichCSS Tier device.
 * // - Removed the deviceXoom variable. It was unused.
 * // - Added detection support for the Obigo mobile browser to
 * DetectMobileQuick().
 * //
 * //
 * //
...
public class UAgentInfo {
	...
	public boolean detectWindowsPhone8() {
		if (this.userAgent.indexOf(deviceWinPhone8) != -1) {
			return true;
		}
		return false;
	}
	...
	public boolean detectBlackBerry10Phone() {
		if ((this.userAgent.indexOf(deviceBB10) != -1) && (this.userAgent.indexOf(mobile) != -1)) {
			return true;
		}
		return false;
	}
	...
	public boolean detectBlackBerryWebKit() {
		if (this.detectBlackBerry() && this.detectWebkit()) {
			return true;
		}
		return false;
	}
	...
	public boolean detectBlackBerryTouch() {
		if (this.detectBlackBerry()
				&& ((this.userAgent.indexOf(deviceBBStorm) != -1) || (this.userAgent.indexOf(deviceBBTorch) != -1)
						|| (this.userAgent.indexOf(deviceBBBoldTouch) != -1) || (this.userAgent.indexOf(deviceBBCurveTouch) != -1))) {
			return true;
		}
		return false;
	}
	...
	public boolean detectWebOSTablet() {
		if ((this.userAgent.indexOf(deviceWebOShp) != -1) && (this.userAgent.indexOf(deviceTablet) != -1)) {
			return true;
		}
		return false;
	}
	...
	public boolean detectOperaAndroidPhone() {
		if ((this.userAgent.indexOf(engineOpera) != -1) && ((this.userAgent.indexOf(deviceAndroid) != -1) && (this.userAgent.indexOf(mobi) != -1))) {
			return true;
		}
		return false;
	}
	...
	public boolean detectOperaAndroidTablet() {
		if ((this.userAgent.indexOf(engineOpera) != -1) && ((this.userAgent.indexOf(deviceAndroid) != -1) && (this.userAgent.indexOf(deviceTablet) != -1))) {
			return true;
		}
		return false;
	}
	...
	public boolean detectKindle() {
		if ((this.userAgent.indexOf(deviceKindle) != -1) && !this.detectAndroid()) {
			return true;
		}
		return false;
	}
	...
	public boolean detectAmazonSilk() {
		if (this.userAgent.indexOf(engineSilk) != -1) {
			return true;
		}
		return false;
	}
	...
	public boolean detectBada() {
		if (this.userAgent.indexOf(deviceBada) != -1) {
			return true;
		}
		return false;
	}
	...
	public boolean detectTizen() {
		if (this.userAgent.indexOf(deviceTizen) != -1) {
			return true;
		}
		return false;
	}
	...
	public boolean detectMeego() {
		if (this.userAgent.indexOf(deviceMeego) != -1) {
			return true;
		}
		return false;
	}
	...
	public boolean detectMaemoTablet() {
		if (this.userAgent.indexOf(maemo) != -1) {
			return true;
		} else if ((this.userAgent.indexOf(linux) != -1) && (this.userAgent.indexOf(deviceTablet) != -1) && !this.detectWebOSTablet() && !this.detectAndroid()) {
			return true;
		}
		return false;
	}
	...
	public boolean detectGamingHandheld() {
		if ((this.userAgent.indexOf(devicePlaystation) != -1) && (this.userAgent.indexOf(devicePlaystationVita) != -1)) {
			return true;
		}
		return false;
	}
	...
	public boolean detectSmartphone() {
		...
		return (this.detectTierIphone() || this.detectS60OssBrowser() || this.detectSymbianOS() || this.detectWindowsMobile() || this.detectBlackBerry() || this
				.detectPalmOS());
	}
	...
	public boolean detectMobileQuick() {
		...
		if ((this.initCompleted == true) || (this.isMobilePhone == true)) {
		...
		if ((this.userAgent.indexOf(engineObigo) != -1) || (this.userAgent.indexOf(engineNetfront) != -1) || (this.userAgent.indexOf(engineUpBrowser) != -1)
				|| (this.userAgent.indexOf(engineOpenWeb) != -1)) {
			return true;
		}
	...
	public boolean detectTierIphone() {
		...
		if (this.detectIphoneOrIpod() || this.detectAndroidPhone() || this.detectWindowsPhone() || this.detectBlackBerry10Phone()
				|| (this.detectBlackBerryWebKit() && this.detectBlackBerryTouch()) || this.detectPalmWebOS() || this.detectBada() || this.detectTizen()
	...
	public boolean detectTierRichCss() {
		...
		if (this.detectMobileQuick()) {
			...
			if (!this.detectTierIphone() && !this.detectKindle()) {

				// The following devices are explicitly ok.
				// Note: 'High' BlackBerry devices ONLY
				// Older Windows 'Mobile' isn't good enough for iPhone Tier.
				if (this.detectWebkit() || this.detectS60OssBrowser() || this.detectBlackBerryHigh() || this.detectWindowsMobile()
						|| (this.userAgent.indexOf(engineTelecaQ) != -1)) {
					result = true;
				}
			}
		}
	...
	public boolean detectTierOtherPhones() {
		...
		if (this.detectMobileLong() && !this.detectTierIphone() && !this.detectTierRichCss()) {
			return true;
		}
	...
	public boolean isMobileOrTablet() {
		return this.detectMobileQuick() || this.detectTierTablet();
	}
}