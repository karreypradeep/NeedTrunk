...
public class ViewContentHandlerBean implements Serializable {
	...
	public boolean isViewContentBranchStudentRegistrationsNotifications() {
		return ViewContentConstant.BRANCH_STUDENT_REGISTRATIONS_NOTIFICATIONS.equals(this.getCurrentViewContent());
	}
	...
	public boolean isViewContentBranchRevenueAcademicYearAnalysis() {
	...
	public boolean isViewContentBranchFeeDueAcademicYearAnalysis() {
		return ViewContentConstant.BRANCH_FEE_DUE_ACADEMIC_YEAR_ANALYSIS.equals(this.getCurrentViewContent());
	}
}
